...
window.ANALYTICS_FUNCTIONS=[],SHGJQ(function(){SHGJQ(".shogun-component, .shg-c").on("click",function(a){var t=SHGJQ(a.target).parent();SHGJQ.each(window.ANALYTICS_FUNCTIONS,function(n,e){e(a,t)})})}),window.GoogleAnalyticsObject||(!function(n,e,a,t,o,c,s){n.GoogleAnalyticsObject=o,n[o]=n[o]||function(){(n[o].q=n[o].q||[]).push(arguments)},n[o].l=1*new Date,c=e.createElement(a),s=e.getElementsByTagName(a)[0],c.async=1,c.src=t,s.parentNode.insertBefore(c,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-31613146-2","auto"),ga("send","pageview")),window.ANALYTICS_FUNCTIONS.push(function(n,e){if((e.hasClass("shogun-component")||e.hasClass("shg-c"))&&e.data("google_analytics-event-label")){var a=e.data("google_analytics-event-label");ga("send","event","button","click",a)}});
;(function($) {
  "use strict"
